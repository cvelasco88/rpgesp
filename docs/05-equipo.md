...
Los precios están expresados en monedas de oro. Los objetos voluminosos ocupan dos espacios salvo que se indique otra cosa. Consulta [Equipo inicial](./01-creacion-personaje-equipo-inicial.md) para las tablas de generación y la equipación con la que comienza un personaje.

### Armaduras

| Objeto | Precio | Protección o nota |
| --- | ---: | --- |
| Escudo | 10 | +1 armadura |
| Yelmo | 10 | +1 armadura |
| Gambesón | 15 | +1 armadura |
| Brigantina | 20 | Armadura 1, voluminosa |
| Cota de malla | 40 | Armadura 2, voluminosa |
| Armadura completa | 60 | Armadura 3, voluminosa |

### Armas

| Objeto | Precio | Daño o nota |
| --- | ---: | --- |
| Daga, garrote, hoz, báculo, etc. | 5 | 1d6 daño |
| Lanza, espada, maza, hacha, mayal, etc. | 10 | 1d8 daño |
| Alabarda, martillo de guerra, espada larga, etc. | 20 | 1d10 daño, voluminosa |
| Honda | 5 | 1d4 daño |
...
| Cubo | 5 | Red | 10 |
| Escalera (3 metros, voluminosa) | 10 | Reloj de arena | 50 |
| Espejo | 5 | Saco | 5 |
