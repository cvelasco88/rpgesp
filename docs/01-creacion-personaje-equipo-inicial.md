...
- [Equipo de partida](#equipo-de-partida)
- [Objetos habituales](#objetos-habituales)
- [Armamento y protección](#armamento-y-proteccion)
- [Regla de carga](#regla-de-carga)
- [Tablas de equipo inicial](#tablas-de-equipo-inicial)
- [Equipo](./05-equipo.md)
...
El equipo se puede dividir en varias categorías:

| Categoría | Ejemplos |
| --- | --- |
| Protección | Casco, chaleco, guantes, armadura ligera |
| Armas | Daga, arma a una mano, arma de distancia, arma improvisada |
| Herramientas | Pico, cuerda, lámpara, navaja, kit de exploración |
| Suministros | Raciones, agua, vendas, tintes, aceite |
| Objetos personales | Reliquias, símbolos, cartas, amuletos |
...
| ---: | --- | ---: | --- |
| 1-3 | Ninguna | 4-14 | Brigantina |
| 15-19 | Cota de malla | 20 | Armadura completa |

### Yelmos y escudos (d20)

| d20 | Resultado | d20 | Resultado |
| ---: | --- | ---: | --- |
| 1-13 | Ninguno | 14-16 | Yelmo |
| 17-19 | Escudo | 20 | Yelmo y escudo |

### Armas (d20)

| d20 | Resultado | d20 | Resultado |
| ---: | --- | ---: | --- |
| 1-5 | Daga, garrote, báculo | 6-14 | Espada, maza, hacha |
| 15-19 | Arco largo, ballesta, honda | 20 | Alabarda, martillo de guerra, hacha de batalla |

### Equipo para expediciones (d20)

| d20 | Equipo | d20 | Equipo |
| ---: | --- | ---: | --- |
| 1 | Aceite combustible | 11 | Pico |
| 2 | Amuleto contra espíritus | 12 | Planta de acónito |
| 3 | Antitoxina | 13 | Polea |
| 4 | Cadena (3 metros) | 14 | Repelente |
| 5 | Carreta (+4 espacios, voluminosa) | 15 | Saco grande |
| 6 | Catalejo | 16 | Soga (8 metros) |
| 7 | Gancho de agarre | 17 | Trampa grande |
| 8 | Ganzúas | 18 | Vara (3 metros) |
| 9 | Grilletes | 19 | Varita de zahorí |
| 10 | Odre para bucear | 20 | Yesquero |
...
| ---: | --- | ---: | --- |
| 1 | Abrojos | 11 | Pala |
| 2 | Caña de pescar | 12 | Palanca |
| 3 | Cincel | 13 | Pegamento |
| 4 | Clavos | 14 | Pinzas de metal |
| 5 | Cubo | 15 | Red |
| 6 | Fuelle | 16 | Reloj de arena |
| 7 | Grasa | 17 | Sellador |
| 8 | Lima de metal | 18 | Serrucho |
| 9 | Martillo | 19 | Taladro manual |
| 10 | Olla para cocinar | 20 | Tiza |

### Baratijas (d20)

| d20 | Objeto | d20 | Objeto |
| ---: | --- | ---: | --- |
| 1 | Botella | 11 | Instrumento musical |
| 2 | Bote de alquitrán | 12 | Jabón |
| 3 | Campana pequeña | 13 | Joyas falsas |
| 4 | Canicas | 14 | Lupa |
| 5 | Cordel | 15 | Mazo de cartas |
| 6 | Cuerno | 16 | Paquete de sal |
| 7 | Dados | 17 | Perfume |
| 8 | Espejo | 18 | Pintura facial |
| 9 | Esponja | 19 | Pluma y tinta |
| 10 | Incienso | 20 | Silbato |

### Objetos adicionales (d20)

Realiza una tirada adicional en la tabla indicada:

| d20 | Resultado | d20 | Resultado |
| ---: | --- | ---: | --- |
| 1-5 | Herramienta o baratija | 6-13 | Equipo para expediciones |
| 14-17 | Armadura o arma | 18-20 | Libro de hechizos |

### Libro de hechizos (d100)

| d100 | Hechizo | d100 | Hechizo | d100 | Hechizo | d100 | Hechizo |
| ---: | --- | ---: | --- | ---: | --- | ---: | --- |
...
| Objeto | Uso |
| --- | --- |
| Antorcha | Iluminación y amenaza a corta distancia |
| Cuerda | Escalada, trampas, manipulación |
| Raciones | Supervivencia y descanso |
| Vendas | Recuperación y estabilización |
| Kit de exploración | Revisión de terreno, pistas, rutas |
| Linterna | Iluminación segura |
| Bolsa | Almacenamiento y orden |

## Armamento y protección

| Clase | Ejemplos |
| --- | --- |
| Armas ligeras | Daga, garrote, cuchillo, martillo pequeño |
| Armas medias | Espada corta, hacha, maza, lanza |
| Armas de distancia | Honda, arco corto, ballesta ligera |
| Protecciones | Casco, peto ligero, guantes, armadura simple |

Cada arma o defensa debe indicar:

- daño base
- alcance o alcance posible
- si requiere una mano
- si tiene usos especiales
...
- penalizaciones en la exploración
- necesidad de dejar objetos atrás
